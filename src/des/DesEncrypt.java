...
public class DesEncrypt {
	...
	public void init() throws IOException {
		...
		tableprepare(adder+"P.txt", P);
		tableprepare(adder+"PC_1.txt", PC_1);
		tableprepare(adder+"PC_2.txt", PC_2);
		tableprepare(adder+"RoundTable.txt", RoundTable);
		Stableprepare(adder+"S.txt",S);
	}
